...
c
        ...
        character*24 file_name1,file_name2,file_name3
          ...
          COMMON /PINF/ PXY(300,2),KCTR(300),KSH(300),KSU(300),
     !           AGL(300,3),NFR(300),HFR(300,15),DOF(300,15),
     !           NSF(300,15),NBL(300),HBL(300,15),DOB(300,15),
     !           PMT(300,15),PFI(300,15),
     !           NSG(300,15),PMB(300),PEH(300),PKE(300)
c
...
c
          COMMON /ESTIF/ ESP(36000,6)
c
          INTEGER PNUM,SNUM
          DIMENSION FORCE(6),ZFR(300),ZBL(300),AO(300),RZZ(300),
     !              DUK(300,6),BTX(300,15),BTY(300,15),SO(6,6)
c           To call a sub to creat program head
           CALL HEAD1
c           To call a sub to read input information from an input file

          WRITE(*,'(/7X,34HPlease enter data filename[*.DAT]:/)')
          READ(*,'(A20)')fname
          WRITE(*,'(34X,A15)')FNAME
...
c         ZFR(300)--   Length of each pile above ground
c         ZFR(300)--   Length of each pile beneath ground
c
...
C       name is 'PINF'.
C
C          COMMON /PINF/ PXY(300,2),KCTR(300),KSH(300),KSU(300),
C     !           AGL(300,3),NFR(300),HFR(300,5),DOF(300,5),NSF(300,5),
C     !           NBL(300),HBL(300,5),DOB(300,5),PMT(300,5),PFI(300,5),
C     !           NSG(300,5),PMB(300),PEH(300),PKE(300)
C
          COMMON /PINF/ PXY(300,2),KCTR(300),KSH(300),KSU(300),
     !           AGL(300,3),NFR(300),HFR(300,15),DOF(300,15),
     !           NSF(300,15),NBL(300),HBL(300,15),DOB(300,15),
     !           PMT(300,15),PFI(300,15),NSG(300,15),PMB(300),PEH(300),
     !           PKE(300)
C
C
...
C          
          COMMON /ESTIF/ESP(36000,6)
C
          DIMENSION FORCE(6),ZFR(300),ZBL(300),JNEW(30),VNEW(30),
     !           AXY(10,2),ACT(10,6),nfb(300),zfb(300,30)
          INTEGER PNUM,SNUM
...
C     !           NSG(300,5),PMB(300),PEH(300),PKE(300)          
     ...
     !           AGL(300,3),NFR(300),HFR(300,15),DOF(300,15),
     !           NSF(300,15),NBL(300),HBL(300,15),DOB(300,15),
     !           PMT(300,15),PFI(300,15),NSG(300,15),PMB(300),
     !           PEH(300),PKE(300)     
C
...
C
          CHARACTER*4 SIG(30)
          DIMENSION JNEW(30),VNEW(30),NIM(300)
          INTEGER PNUM
          KK=0
          DO 50 K=1,PNUM
...
C
          INTEGER PNUM
          REAL KINF(2),KA
          DIMENSION ZFR(PNUM),ZBL(PNUM),BTX(300,15)
          DIMENSION BTY(300,15),GXY(300,2)
          DO 110 K=1,PNUM
...
c   less than 1.0 m. 
          ...
          INTEGER PNUM
          REAL KINF
          DIMENSION DOB(PNUM),ZBL(PNUM),GXY(300,2),
     !              AA(300),DD(300),ZZ(300)
          IN=1
          AA(1)=GXY(1,IM)
          DD(1)=DOB(1)
          ZZ(1)=ZBL(1)
...
c   greater than 1.0 m. 
          ...
          INTEGER PNUM
          REAL KINF,KMIN
          DIMENSION DOB(PNUM),ZBL(PNUM),GXY(300,2),NIN(300),
     !              IN(300),NOK(300,300),AA(300),DD(300),ZZ(300)
          IM1=1
          IF(IM.EQ.1) IM1=2
          NROW=0
          DO 131 K=1,PNUM
...
c******************************************************
          ...
          REAL KINF
          DIMENSION AA(IN),DD(IN),ZZ(IN),HO(300)
          IF(IN.EQ.1) THEN
            KINF=1.0
            GOTO 2200
          END IF
...
1030  FORMAT(50X,'<Earthquake resist Group>')
...
1030  FORMAT(30X,'<Earthquake resist Group>')
1040  FORMAT(30X,'Dept.of Bridge Engr.')
1050  FORMAT(30X,'Tongji University')
1060  FORMAT(30X,'1239 Sipin Road ')
1070  FORMAT(30X,'Shanghai 200092')
1080  FORMAT(30X,'P.R.of China'/)
1090  FORMAT(7X,'*******************************************************
     -************************************'/)
      RETURN
      END
...
C
          INTEGER PNUM
          DIMENSION ZFR(PNUM),ZBL(PNUM),AO(PNUM),BXY(300,2),
     !              W(300),SMIN(300)
          DO 81 K=1,PNUM
...
C
          COMMON /ESTIF/ESP(36000,6)
          INTEGER PNUM
          DIMENSION BTX(300,15),BTY(300,15),BT1(15),BT2(15),EJ(15),
     !         H(66),RZZ(PNUM)
...
c
          ...
          INTEGER PNUM,SNUM
          COMMON /ESTIF/ ESP(36000,6)
          DIMENSION PXY(300,2),SXY(20,2),AGL(300,3),FORCE(6),
     !              TU(6,6),TN(6,6),B(6,6),SO(6,6),DUK(300,6),
...
C
          COMMON /ESTIF/ ESP(36000,6)
C
          DIMENSION BTX(300,15),BTY(300,15),DUK(300,6),CE(6),SE(6,6),
     !       PE(6),ZH(300),FX(300,4),FY(300,4),FZ(300),R(4,4),
     !       XA(4),XB(4),XC(4),XD(4),PSX(300),PSY(300)
          INTEGER PNUM
